    ...
    internal abstract class DropboxDaoBase
    {
        ...
        protected Folder ToFolder(FolderMetadata dropboxFolder)
        {
            ...
            var folder = new Folder
            {
                ...
                ParentFolderID = isRoot ? (DropboxProviderInfo.RootFolderType == FolderType.COMMON ? Global.FolderCommon : Global.FolderMy) : MakeId(GetParentFolderPath(dropboxFolder)),
