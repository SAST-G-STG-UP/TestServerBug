...
{
    public class OCMigratingContacts : MigratingContacts
    {
        ...
        private List<OCContact> contacts = new List<OCContact>();
        private OCMigratingUser user;
        private OCAddressbooks addressbooks;

        public OCMigratingContacts(OCMigratingUser user, OCAddressbooks addressbooks, Action<string, Exception> log) : base(log)
        {
            this.user = user;
