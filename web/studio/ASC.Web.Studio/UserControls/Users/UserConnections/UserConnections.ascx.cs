...
{
    public partial class UserConnections : UserControl
    {
        public static string Location
        {
            get { return "~/UserControls/Users/UserConnections/UserConnections.ascx"; }
        }

        protected void Page_Load(object sender, EventArgs e)
        {
            confirmLogoutDialog.Options.IsPopup = true;
            confirmLogoutConnectionDialog.Options.IsPopup = true;
        }
