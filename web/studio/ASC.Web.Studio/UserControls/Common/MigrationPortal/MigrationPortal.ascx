<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MigrationPortal.ascx.cs" Inherits="ASC.Web.Studio.UserControls.Common.MigrationPortal.MigrationPortal" %>
