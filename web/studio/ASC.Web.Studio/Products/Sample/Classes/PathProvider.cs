...
namespace ASC.Web.Sample.Classes
{
    public class PathProvider
    {
        ...
        public static string GetFileStaticRelativePath(String fileName)
        {
            ...
            {
                case ".js":
                    return VirtualPathUtility.ToAbsolute("~/Products/Sample/js/" + fileName);
                case ".png":
                    return WebPath.GetPath("/Products/Sample/App_Themes/default/images/" + fileName);
                case ".ascx":
                    return CommonLinkUtility.ToAbsolute("~/Products/Sample/Controls/" + fileName);
                case ".css":
                case ".less":
                    return VirtualPathUtility.ToAbsolute("~/Products/Sample/App_Themes/default/css/" + fileName);
            }
            return fileName;
        }
