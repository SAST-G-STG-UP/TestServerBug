...
<%@ Page Language="C#" MasterPageFile="~/Products/People/Masters/PeopleBaseTemplate.Master" AutoEventWireup="true"
 CodeBehind="Birthdays.aspx.cs" Inherits="ASC.Web.People.Birthdays" %>
            ...
            <td>
                ...
                <% { %>
                    ...
                    <div class="user-info">
                        ...
                        <div class="user-info-title gray-text"><%= usr.Title.HtmlEncode() %></div>
                        <a class="<%= usr.ID == SecurityContext.CurrentAccount.ID ? "display-none" : "button blue middle" %>"
                                onclick="ASC.People.Birthdays.openContact(this);"
                        ...
                        <div class="small-user-card clearFix <%= IsInRemindList(usr.ID) ? "active" : "" %>">
                            ...
                            <div class="user-info">
                                ...
                                <div class="user-info-title <%= usr.ID == SecurityContext.CurrentAccount.ID ? "display-none" : "" %>">
                                    <a class="baseLinkAction gray-text birthday-remind" onclick="ASC.People.Birthdays.remind(this, true);">
                                        <%= BirthdaysResource.BirthdayRemindLinkTitle%>
                                    </a>
                                    <span class="birthday-remind-active">
                                        <%= BirthdaysResource.BirthdayRemindReadyLinkTitle%>
                                        <a onclick="ASC.People.Birthdays.remind(this, false);"></a>
                                    </span>
                                </div>
